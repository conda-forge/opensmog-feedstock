...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opensmog-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13630&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opensmog-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opensmog` can be installed with:

```
conda install opensmog
```

It is possible to list all of the versions of `opensmog` available on your platform with:
